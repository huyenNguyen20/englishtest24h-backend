...
export const batchDeleteImage = async (fileNameArr: string[])
  : Promise<void> => {
      try{
...
export const batchDeleteAudio = async (fileNameArr: string[])
  : Promise<void> => {
      try{
          // Require neccessary library
          const AWS = require('aws-sdk');
...
export const compressAndUploadImage = async (tempFile: string, fileName: string)
    : Promise<string> => {
        try{
             // Require neccessary library
            const AWS = require('aws-sdk');
